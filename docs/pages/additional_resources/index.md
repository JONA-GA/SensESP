...
- [HALSER Wind Interface](https://github.com/hatlabs/HALSER-wind-interface): Autonnic A5120 ultrasonic wind instrument to NMEA 2000 and Signal K gateway, built on [HALSER](https://shop.hatlabs.fi/products/halser).
- [HALSER AIS Interface](https://github.com/hatlabs/HALSER-ais-interface): Matsutec HA-102 AIS transponder to NMEA 2000 and Signal K gateway, built on [HALSER](https://shop.hatlabs.fi/products/halser).
- [HALSER CV7 Wind Interface](https://github.com/BoatHacks/HALSER-cv7-wind-interface): HALSER Wind Interface adapted for the LCJ Capteurs CV7 ultrasonic wind instrument. Since the CV7 is transmit-only, the wind vane reference angle offset is applied in software instead of in the instrument.
- [HALSER CV7 + HWT3100 Interface](https://github.com/humppafreak/HALSER-cv7-hwt3100-interface): CV7 wind interface extended with an optional WitMotion HWT3100 fluxgate compass read over Modbus RTU (PGN 127250 / `navigation.headingMagnetic`), UDP NMEA 0183 broadcast on port 10110 for chartplotter apps, and web UI toggles for each input and output. Not yet tested on hardware.
